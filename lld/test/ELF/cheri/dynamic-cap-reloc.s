...
# DYN-RELOCS-NEW: 0x000000007000C000 MIPS_CHERI___CAPRELOCS 0x418
...
# DYN-RELOCS-NEW-NEXT:   0x0204f0 (local_ref) Base: 0x104c0 (bar+0) Length: 8 Perms: Function
# DYN-RELOCS-NEW-NEXT:   0x020530 (local_ref_with_addend) Base: 0x104c0 (bar+4) Length: 8 Perms: Function
...
# DUMP-NEW-NEXT: 0x00000000000204f0	Base: bar (0x00000000000104c0)	Offset: 0x0000000000000000	Length: 0x0000000000000008	Permissions: 0x8000000000000000 (Function)
# DUMP-NEW-NEXT: 0x0000000000020530	Base: bar (0x00000000000104c0)	Offset: 0x0000000000000004	Length: 0x0000000000000008	Permissions: 0x8000000000000000 (Function)
