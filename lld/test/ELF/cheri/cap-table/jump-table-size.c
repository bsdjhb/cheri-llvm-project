...
// EXE: SYMBOL TABLE:
// EXE-DAG: 0000000000010300 l        .rodata		 0000000000000024 .LJTI0_0
// EXE-DAG: 00000000000303c0 l     O .captable		 00000000000000{{1|2}}0 .LJTI0_0@CAPTABLE

// __cap_relocs should contain length:
// EXE:      CAPABILITY RELOCATION RECORDS:
// EXE-NEXT: 0x00000000000303c0	Base: .LJTI0_0 (0x0000000000010300)	Offset: 0x0000000000000000	Length: 0x0000000000000024	Permissions: 0x4000000000000000 (Constant)

// EXE: 20364:	3c 01 00 00 	lui	$1, 0
// EXE-NEXT: 20368:	64 21 00 00 	daddiu	$1, $1, 0
// EXE-NEXT: 2036c:	d8 3a 08 00 	clc	$c1, $1, 0($c26)
