...
// HEADERS-NEXT: 07     .text .gcc_except_table .data .captable
// HEADERS-NEXT: 08
...
// RV64-RELOCS-NEXT:   0x002{{.+}} Base: 0x1{{.+}} (.L_Z4testll$eh_alias+96) Length: 8768 Perms: Function
// RV64-RELOCS-NEXT:   0x002{{.+}} Base: 0x1{{.+}} (.L_Z4testll$eh_alias+72) Length: 8768 Perms: Function
// RV64-RELOCS-NEXT: ]
