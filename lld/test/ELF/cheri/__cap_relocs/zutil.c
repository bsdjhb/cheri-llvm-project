...
// CHECK-NEXT:  0x0000000000020580	Base: <Unnamed symbol> (0x0000000000000481)	Offset: 0x0000000000000000	Length: 0x0000000000000010	Permissions: 0x4000000000000000 (Constant)
// CHECK-NEXT:  0x00000000000205{{9|a}}0	Base: <Unnamed symbol> (0x0000000000000491)	Offset: 0x0000000000000000	Length: 0x000000000000000b	Permissions: 0x4000000000000000 (Constant)
// CHECK-NEXT:  0x00000000000205{{a|c}}0	Base: <Unnamed symbol> (0x000000000000[[RODATA_ADDR:0480]])	Offset: 0x0000000000000000	Length: 0x0000000000000001	Permissions: 0x4000000000000000 (Constant)
// CHECK-EMPTY:
